...
from asaprl.utils.rl_utils.evaluator_utils import MetadriveRuleExpertEvaluator
...
def main(cfg):
    ...
    evaluator = MetadriveRuleExpertEvaluator(cfg.policy.eval.evaluator, evaluator_env, policy.eval_mode, tb_logger, exp_name=cfg.exp_name)

    eval_everage_reward = evaluator.eval('intersection')
    evaluator.close()
