...
from asaprl.policy.collect_sac import CollectlSAC
...
def main(cfg):
    ...
    policy = CollectlSAC(cfg.policy, model=model)
...
# diff with vis.py
    # use_render=False
    # show_seq_traj = False
    # n_evaluator_episode=200
    # MetadriveExpertEvaluator instead of MetadriveEvaluator
# python demo/metadrive/c_iros_straight/z0_exp3_sac_straight_dev_collect.py --exp_name 'taecrl++fixed10_0725_RV27_lat5_highway' --traj_mode 'planningfixed' --action_shape 3 --SEQ_TRAJ_LEN 10 --reward_version 27 --lat_range 5
