...
from ding.worker import InteractionSerialEvaluator, NaiveReplayBuffer
...
parser.add_argument('--exp_name', type=str, default='asaprl')
...
parser.add_argument('--DECODER_LOAD_DIR', type=str, default='pretrain_ckpt_files/seq_len_10_decoder_ckpt')   # the directory of the trained trajecotry decoder, for SPiRL and TaEcRL
...
def main(cfg):
    ...
    if cfg.policy.pretraining:
        ...
        policy._model.actor.load_state_dict(pretrained_actor)   # onlye training model
