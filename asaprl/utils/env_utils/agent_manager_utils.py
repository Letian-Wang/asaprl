...
from asaprl.utils.env_utils.agent_policy import AgentSkillPolicy
from asaprl.utils.env_utils.vehicle_utils import MacroDefaultVehicle
...
class MacroAgentManager(AgentManager):
    ...
    def _get_policy(self, obj):
        policy = AgentSkillPolicy(obj, self.generate_seed())
        return policy
